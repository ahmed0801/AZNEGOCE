...
class VoiceCommandController extends Controller
{
    public function handle(Request $request)
    {
        ...
        $triggers = ['commande achat', 'propose une commande', 'proposition d\'achat', 'réapprovisionnement','bonjour Ahmed, propose une commande achat selon la rotaion de notre stock'];
