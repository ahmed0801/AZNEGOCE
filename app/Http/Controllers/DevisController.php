...
class DevisController extends Controller
{
    ...
    {
        $entetedevis = Entetepanier::where('type', 'devis')
    ...
    {
        $entetedevis = Entetepanier::where('type', 'brouillon')
        ->orderBy('created_at', 'desc')
        ->take(100)
        ->get();
        return view('listbrouillon', compact('entetedevis'));
    }
    ...
    public function showbrouillon($id)
    {
        // On récupère l'entête du devis
        $entetedevis = Entetepanier::findOrFail($id);
        // dd($entetedevis);
        ...
        return view('brouillon_details', compact('entetedevis', 'details'));
    }
