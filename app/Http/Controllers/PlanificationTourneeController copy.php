...
class PlanificationTourneeController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->filled('date_debut')) {
            $query->whereDate('datetime_planifie', '>=', $request->date_debut);
        }
        if ($request->filled('date_fin')) {
            $query->whereDate('datetime_planifie', '<=', $request->date_fin);
        }
        ...
        return view('planification_tournee.index', compact('planifications', 'chauffeurs'));
    }
