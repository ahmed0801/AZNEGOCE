                ...
                <div class="card mb-4 shadow-sm border-0">
                    <div class="card-header bg-white d-flex justify-content-between align-items-center border-start border-4 border-primary">
                        ...
                        @if($return->purchaseOrder)
                            <a href="{{ route('purchases.list') }}?numdoc={{ $return->purchaseOrder->numdoc }}">{{ $return->purchaseOrder->numdoc }}</a> –
                        @else
                            Géneré a partir d'un Avoir –
                        @endif                                
Fournisseur : {{ $return->supplier ? $return->supplier->name : 'N/A' }}
                        ...
                        <div class="btn-group">
                            ...
                            <a href="{{ route('returns.print_single', $return->id) }}" class="btn btn-xs btn-outline-primary" title="Télécharger PDF" target="_blank">
