    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="createItemModalLabel">Créer Une Marque</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
            </div>

            <div class="modal-body">
                <form id="createItemForm" action="{{ route('brand.store') }}" method="POST">
                    @csrf
...
<div class="mb-1 d-flex justify-content-center">
    <input type="text" id="searchItemInput" class="form-control search-box" placeholder="🔍 Rechercher une Marque...">
</div>
                ...
                @foreach ($brands as $brand)
                    <tr>
                        ...
                        <td>
                            <!-- Modifier -->
<!-- Modifier -->
<button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editItemModal{{ $brand->id }}">
    <i class="fas fa-edit"></i>
</button>


                            <!-- Supprimer -->
                            <form action="{{ route('brand.destroy', $brand->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Supprimer cette Marque ?')">
                                @csrf
                                @method('DELETE')
...
<div class="modal fade" id="editItemModal{{ $brand->id }}" tabindex="-1" aria-labelledby="editItemModalLabel{{ $brand->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">Modifier la marque : {{ $brand->name }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
            </div>
