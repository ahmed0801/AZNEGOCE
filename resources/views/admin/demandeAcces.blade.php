    ...
    <tr>
        ...
        <td>
            <form action="{{ route('admin.mettreAJourDemande', $request->id) }}" method="POST">
                @csrf
                <textarea name="client_name" class="form-control" placeholder="Nom du client" rows="2">{{ $request->client_name }}</textarea>
        </td>
        <td>
            <textarea name="requester_name" class="form-control" placeholder="Nom du demandeur" rows="2">{{ $request->requester_name }}</textarea>
        </td>
        <td>
            <textarea name="whatsapp_number" class="form-control" placeholder="Numéro WhatsApp" rows="2">{{ $request->whatsapp_number }}</textarea>
        </td>
        <td>
        ...
        <td>
            <textarea name="numclient" class="form-control" placeholder="Num client" rows="2">{{ $request->numclient }}</textarea>
        </td>
