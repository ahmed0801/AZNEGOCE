    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="createItemForm" action="{{ route('groupremise.store') }}" method="POST">
                    @csrf
...
<div class="mb-1 d-flex justify-content-center">
    <input type="text" id="searchItemInput" class="form-control search-box" placeholder="🔍 Rechercher un Groupe Remise...">
</div>
  ...
  @if ($groupremises->count() > 0)
    <div class="table-responsive">
        <table class="table table-bordered table-hover table-text-small" id="itemsTable">
            ...
            <tbody>
                @foreach ($groupremises as $groupremise)
                    <tr>
                        ...
                        <td>
                            <!-- Modifier -->
<!-- Modifier -->
<button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editItemModal{{ $groupremise->id }}">
    <i class="fas fa-edit"></i>
</button>


                            <!-- Supprimer -->
                            <form action="{{ route('groupremise.destroy', $groupremise->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Supprimer ce groupe ?')">
                                @csrf
                                @method('DELETE')
...
<div class="modal fade" id="editItemModal{{ $groupremise->id }}" tabindex="-1" aria-labelledby="editItemModalLabel{{ $groupremise->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('groupremise.update', $groupremise->id) }}" method="POST">
                    @csrf
                    @method('PUT')
