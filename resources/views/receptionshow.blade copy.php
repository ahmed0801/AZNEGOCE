...
<div class="u-text">
  ...
  <div class="page-inner">
      ...
      <div class="container">
    <h3>📦 Détails de la réception #{{ $reception->id }} (Commande : {{ $reception->purchaseOrder->numdoc }})</h3>

    <p><strong>Date de réception :</strong> {{ \Carbon\Carbon::parse($reception->reception_date)->format('d/m/Y') }}</p>
