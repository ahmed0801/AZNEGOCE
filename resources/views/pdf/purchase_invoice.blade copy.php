        ...
        <div class="totals-box">
            <table>
                ...
                <tr>
                    ...
                    <td><strong>{{ number_format($totalHT * ($invoice->tva_rate / 100), 2, ',', ' ') }} € ({{ number_format($invoice->tva_rate, 2) }}%)</strong></td>
                </tr>
                <tr>
                    <td class="label"><strong>Total TTC :</strong></td>
                    <td><strong>{{ number_format($invoice->total_ttc, 2, ',', ' ') }} €</strong></td>
                </tr>
            </table>
        </div>
    </main>
