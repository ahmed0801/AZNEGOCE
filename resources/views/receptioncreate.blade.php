...
<div class="u-text">
    ...
    <div class="page-inner">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Réception Achat</h5>
            </div>
            <div class="card-body">

                <h4 class="mb-4">📦 Réception de la commande #{{ $order->id }}</h4>
    ...
    <form method="POST" action="{{ route('receptions.store') }}">
        ...
        <div class="form-group mb-3">
            ...
            <input type="date" name="reception_date" class="form-control" value="{{ date('Y-m-d') }}" required>
        </div>
            ...
            <tbody>
                @foreach ($order->lines as $i => $line)
                    <tr>
                        ...
                        <td>
                            <input type="number" class="form-control" name="lines[{{ $i }}][received_quantity]" value="{{ $line->ordered_quantity }}" min="0" max="{{ $line->ordered_quantity }}" required>
                            <input type="hidden" name="lines[{{ $i }}][article_code]" value="{{ $line->article_code }}">
                        </td>
                    </tr>
                @endforeach
            </tbody>
        ...
        <div class="text-end mt-4">
            ...
            <a href="{{ route('purchases.list') }}" class="btn btn-secondary">Annuler</a>
        </div>
    </form>
