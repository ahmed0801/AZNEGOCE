...
<div class="u-text">
    ...
    <form action="{{ route('logout.admin') }}" method="POST" style="display: inline;">
        ...
        <h4>Informations de l'entreprise</h4>
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('company_information.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf

                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <label for="name" class="form-label">Nom de l'entreprise</label>
                                <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $company ? $company->name : 'Test Company S.A.R.L') }}" required>
                                @error('name')
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="address" name="address" value="{{ old('address', $company ? $company->address : '123 Rue Fictive, Tunis 1000') }}" required>
                                @error('address')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" value="{{ old('phone', $company ? $company->phone : '+216 12 345 678') }}" required>
                                @error('phone')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $company ? $company->email : 'contact@testcompany.com') }}" required>
                                @error('email')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="swift" name="swift" value="{{ old('swift', $company ? $company->swift : 'TESTTNTT') }}">
                                @error('swift')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="rib" name="rib" value="{{ old('rib', $company ? $company->rib : '123456789012') }}">
                                @error('rib')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" class="form-control" id="iban" name="iban" value="{{ old('iban', $company ? $company->iban : 'TN59 1234 5678 9012 3456 7890') }}">
                                @error('iban')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3 col-md-6">
                                ...
                                <img id="logo-preview" alt="Prévisualisation du logo">
                                @if($company && $company->logo_path)
                                    <div class="mt-2">
                                        <img src="{{ asset($company->logo_path) }}" alt="Logo actuel" style="max-height: 100px; border-radius: 5px;">
                                        <small class="d-block mt-1">Logo actuel : {{ $company->logo_path }}</small>
                                    </div>
                                @endif
                                @error('logo')
                                    <div class="text-danger">{{ $message }}</div>
