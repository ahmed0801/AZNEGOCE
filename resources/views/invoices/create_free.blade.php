    ...
    <div class="page-inner">
        ...
        <div class="card shadow-sm">
            <div class="card-header bg-primary text-white">
                <h5 class="mb-0">Créer une facture libre</h5>
            </div>
            <div class="card-body">
              <form action="{{ route('invoices.store') }}" method="POST">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <input type="number" step="0.01" id="tva_display" name="tva_display" class="form-control" readonly>
                        </div>
                        <div class="col-md-6">
                    ...
                    <table class="table table-bordered" id="linesTable">
                        ...
                        <tbody id="lines">
                            <tr>
                                <td><input type="text" name="lines[0][description]" class="form-control description" required placeholder="Ex: Bouteilles d'eau"></td>
                                <td><input type="number" name="lines[0][quantity]" class="form-control qty" required></td>
                                <td><input type="number" step="0.01" name="lines[0][unit_price_ht]" class="form-control pu" required></td>
                                <td><input type="number" step="0.01" name="lines[0][remise]" class="form-control remise" value="0"></td>
                                <td><input type="text" name="lines[0][tva]" class="form-control tva_ligne" readonly></td>
...
<script>
let lineIndex = 1;
const tvaMap = {!! json_encode($tvaMap) !!};
...
$(document).ready(function() {
    ...
    $('#addLine').click(function() {
        ...
        const newRow = `
            <tr>
                <td><input type="text" name="lines[${lineIndex}][description]" class="form-control description" required placeholder="Ex: Fournitures informatiques"></td>
