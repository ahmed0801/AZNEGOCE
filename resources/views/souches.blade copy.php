...
<div class="container mt-4">
    <div class="card shadow rounded">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Créer une Souche</h5>
        </div>
        <div class="card-body">
            @if (session('success'))
            ...
            <form action="{{ route('souches.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="mb-3 col-md-6">
                        <label for="name" class="form-label">Nom de la souche *</label>
                ...
                <div class="row">
                    <div class="mb-3 col-md-4">
                        ...
                        <input type="text" name="prefix" class="form-control" placeholder="Ex: CLT-">
                    </div>

                    <div class="mb-3 col-md-4">
                        <label for="number_length" class="form-label">Longueur du numéro *</label>
                        <input type="number" name="number_length" class="form-control" value="5" required>
                    </div>

                    <div class="mb-3 col-md-4">
                        <label for="suffix" class="form-label">Suffixe</label>
                        <input type="text" name="suffix" class="form-control" placeholder="Ex: -2025">
                    </div>
                </div>
