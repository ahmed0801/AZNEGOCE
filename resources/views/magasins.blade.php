    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="createItemModalLabel">Créer Une Magasin</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
            </div>

            <div class="modal-body">
                <form id="createItemForm" action="{{ route('magasin.store') }}" method="POST">
                    @csrf
...
<div class="mb-1 d-flex justify-content-center">
    <input type="text" id="searchItemInput" class="form-control search-box" placeholder="🔍 Rechercher une Magasin...">
</div>
                ...
                @foreach ($magasins as $magasin)
                    <tr>
                        ...
                        <td>
                            <!-- Modifier -->
<!-- Modifier -->
<button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editItemModal{{ $magasin->id }}">
    <i class="fas fa-edit"></i>
</button>


                            <!-- Supprimer -->
                            <form action="{{ route('magasin.destroy', $magasin->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Supprimer cette Magasin ?')">
                                @csrf
                                @method('DELETE')
...
<div class="modal fade" id="editItemModal{{ $magasin->id }}" tabindex="-1" aria-labelledby="editItemModalLabel{{ $magasin->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">Modifier la magasin : {{ $magasin->name }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
            </div>

            <div class="modal-body">
                <form action="{{ route('magasin.update', $magasin->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                        <!-- Exemple champ désignation -->
                         ...
                         <div class="mb-3 col-md-4">
                            ...
                            <input type="text" name="name" class="form-control" value="{{ $magasin->name }}" required>
                        </div>
                        <div class="mb-3 col-md-8">
                            <label class="form-label">Description</label>
                            <input type="text" name="description" class="form-control" value="{{ $magasin->description }}" required>
                        </div>
