...
<div class="u-text">
    ...
    <form action="{{ route('logout.admin') }}" method="POST" style="display: inline;">
        ...
        <div class="container mt-4">
         ...
         <h4>Paramètres Achats</h4>
            <p class="text-muted">Configurez les paramètres liés à la gestion des commandes d'achat et des retours.</p>

            <div class="card">
                <div class="card-body">
                    <form action="{{ route('purchase-settings.store') }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row">
                            <div class="mb-3 col-md-6">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="reception_obligatoire_validation" 
                                           name="reception_obligatoire_validation" 
                                           value="1" {{ old('reception_obligatoire_validation', $parametres->reception_obligatoire_validation ?? 0) ? 'checked' : '' }}>
                                    <label for="reception_obligatoire_validation" class="form-check-label">
                                        Réception obligatoire pour valider une commande
                                    </label>
                                </div>
                                <small class="form-text text-muted">
                                    Si coché, une réception doit être enregistrée avant de pouvoir valider une commande d'achat.
                                </small>
                                @error('reception_obligatoire_validation')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            <div class="mb-3 col-md-6">
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="reception_obligatoire_retour" 
                                           name="reception_obligatoire_retour" 
                                           value="1" {{ old('reception_obligatoire_retour', $parametres->reception_obligatoire_retour ?? 1) ? 'checked' : '' }}>
                                    <label for="reception_obligatoire_retour" class="form-check-label">
                                        Réception obligatoire pour créer un retour
                                    </label>
                                </div>
                                <small class="form-text text-muted">
                                    Si coché, une réception terminée (statut Reçu ou Partiel) est requise pour créer un retour d'achat.
                                </small>
                                @error('reception_obligatoire_retour')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        </div>
