    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-header">
                <h5 class="modal-title" id="createItemModalLabel">Créer une Utilisateur</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
            </div>

            <div class="modal-body">
                <form id="createItemForm" action="{{ route('unit.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-4">
                            ...
                            <input type="text" class="form-control" id="name" name="label" required>
                        </div>
                ...
                @foreach ($units as $unit)
                    <tr>
                        ...
                        <td>
                            <!-- Modifier -->
<!-- Modifier -->
<button class="btn btn-sm btn-warning" data-bs-toggle="modal" data-bs-target="#editItemModal{{ $unit->id }}">
    <i class="fas fa-edit"></i>
</button>


                            <!-- Supprimer -->
                            <form action="{{ route('unit.destroy', $unit->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Supprimer cette Unité ?')">
                                @csrf
                                @method('DELETE')
...
<div class="modal fade" id="editItemModal{{ $unit->id }}" tabindex="-1" aria-labelledby="editItemModalLabel{{ $unit->id }}" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">

            <div class="modal-header">
                <h5 class="modal-title">Modifier l'unité : {{ $unit->name }}</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Fermer"></button>
            </div>
                ...
                <form action="{{ route('unit.update', $unit->id) }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-8">
                            ...
                            <input type="text" name="label" class="form-control" value="{{ $unit->label }}" required>
                        </div>
