                            ...
                            <tbody>
                                @foreach($customer->vehicles as $vehicle)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('customer.vehicle.catalog', [$customer->id, $vehicle->id]) }}" class="btn btn-sm btn-primary">
...
<!-- Script to prevent modals from auto-opening and ensure customers table visibility -->
<script>
document.addEventListener("DOMContentLoaded", function () {
    ...
    // Ensure customers table is visible
    const customersTable = document.getElementById('itemsTable');
    if (customersTable) {
