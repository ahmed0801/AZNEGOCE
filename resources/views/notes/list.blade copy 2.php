                        ...
                        <h4>📄 Liste des avoirs d'achat :
                            <div class="btn-group">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @else
                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#selectReturnModal">À partir d’un retour</a>
                                    @endif
                                    @if($invoices->isEmpty())
                                        <a class="dropdown-item disabled" href="#">À partir d’une facture (aucune facture disponible)</a>
                                    @else
                                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#selectInvoiceModal">À partir d’une facture</a>
                                    @endif
                                </div>
                            </div>
                        </h4>
...
<div class="modal fade" id="selectInvoiceModal" tabindex="-1" role="dialog" aria-labelledby="selectInvoiceModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form id="createFromInvoiceForm" action="{{ route('notes.create_from_invoice', '') }}" method="GET">
                ...
                <div class="modal-body">
                    ...
                    @else
                        <select id="invoice_id" name="invoice_id" class="form-select select2" style="width: 100%;">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" id="createFromInvoiceButton" class="btn btn-outline-primary btn-sm" disabled>Créer l’avoir</button>
                </div>
            </form>
        </div>
    </div>
                            ...
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    <form id="createFromInvoiceForm" action="{{ route('notes.create_from_invoice', '') }}" method="GET">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button" class="btn btn-outline-secondary btn-sm" data-dismiss="modal">Annuler</button>
                                            <button type="button" id="createFromInvoiceButton" class="btn btn-outline-primary btn-sm" disabled>Créer l’avoir</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
